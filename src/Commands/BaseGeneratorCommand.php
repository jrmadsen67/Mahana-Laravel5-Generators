...
abstract class BaseGeneratorCommand extends Command {
	...
	/**
	 * Wrap each member of comma-delimited list with quotes and return string
	 *
	 * @param  string  $list
	 * @return string
	 */
	protected function parseStringToArray($list) {
		return implode(',', array_map(function ($val) {return sprintf('"%s"', $val);}, explode(',', $list)));
	}
